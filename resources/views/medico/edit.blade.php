      ...
      <div class="tile">
        ...
        <div class="tile-body">
            ...
            <div class="form-group">
              ...
              value="{{ (old('nombre')) ? old('nombre') : $medico->user->nombre }}"
            ...
            <div class="form-group">
              ...
              value="{{ (old('apellido')) ? old('apellido') : $medico->user->apellido}}"
            ...
            <div class="form-group">
              ...
              value="{{ (old('email')) ? old('email') : $medico->user->email }}"
              required autocomplete>
            ...
            <div class="form-group" id="form-group-especialidad">
                ...
                <select class="form-control" id="especialidad" name="especialidad">
                    ...
                    @endforeach
                    <option value="{{ $medico->especialidad->nombre }}" selected>{{ $medico->especialidad->nombre }}</option>
                </select>
